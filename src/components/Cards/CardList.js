...
const CardList = ({onRouteChange}) => {
  return (
    <div>
      <div onClick ={()=>onRouteChange('Jobs')} className="tc dib br3 pa3 ma3 grow bw3 shadow-5" style={{backgroundColor:'rgb(189, 218, 165)',width:'31%'}}>
      ...
      <div onClick ={()=>onRouteChange('Blogs')} className="tc dib br3 pa3 ma3 grow bw3 shadow-5" style={{backgroundColor:'rgb(189, 218, 165)',width:'31%'}}>
      ...
      <div onClick ={()=>onRouteChange('Schemes')} className="tc dib br3 pa3 ma3 grow bw3 shadow-5" style={{backgroundColor:'rgb(189, 218, 165)',width:'31%'}}>
      ...
      <div onClick ={()=>onRouteChange('NGOs')} className="tc dib br3 pa3 ma3 grow bw3 shadow-5" style={{backgroundColor:'rgb(189, 218, 165)',width:'31%'}}>
