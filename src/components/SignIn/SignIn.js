        ...
        <div className="c2">
            ...
            <form action="">
                ...
                <div className="input"><svg className="svg-icon" viewBox="0 0 20 20">
                    ...
                    </svg><input type="password" placeholder="Password"/></div>
                <input onClick={onRouteChange} className="submit" type="button" value="Sign in"/>
            </form>
            <hr/>
            <div className="end">
                Not a member yet?
                <div><button className="submit up"><a href="">Sign up</a></button></div>
            </div>
        </div>
    </div>
    );
