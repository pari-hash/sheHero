  ...
  return (
    ...
    <nav style={{ display:'flex',justifyContent:'space-between' }}>
      ...
      <nav style={{ display:'flex',justifyContent: "center" }}>
        ...
        <p className="f3 link dim black pa3 pointer" style={{color:'rgb(189, 218, 165)'}}>Government Schemes</p>
        <p className="f3 link dim black pa3 pointer" style={{color:'rgb(189, 218, 165)'}}>Crisis Hotline</p>
      </nav>
      <nav style={{ display:'flex',justifyContent: "flex-end" }}>
        <p className="f3 link dim black pa3 pointer" style={{color:'rgb(189, 218, 165)'}}>Sign In</p>
        <p className="f3 link dim black pa3 pointer" style={{color:'rgb(189, 218, 165)'}}>Sign Up</p>
      </nav>
    </nav>
    </div>
  );
